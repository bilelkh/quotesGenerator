        ...
        <div class="card z-index-0">
          ...
          <div class="card-body">
            <form @submit.prevent="login" ref="form" >
              <div class="mb-3">
                <vsud-input type="text" placeholder="Name" aria-label="Name"  v-model="register_form.name" />
              </div>
              <div class="mb-3">
                <vsud-input type="email" placeholder="Email" aria-label="Email" v-model="register_form.email" />
              </div>
              <div class="mb-3">
                <vsud-input type="password" placeholder="Password" aria-label="Password" v-model="register_form.password"/>
              </div>
